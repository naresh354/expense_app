...
const LoginForm = () => {
  ...
  const handleFormSubmit = (values: any) => {
    ...
    axiosService
      .postUserService("/user/register", values)
      .then((res: any) => {
      ...
      <Box sx={customStyles.formContainer}>
        <Box sx={{ textAlign: "center" }}>
          ...
          <FormControl sx={{ width: "35ch" }} variant="standard">
            ...
            <FormControl sx={{ width: "35ch" }} variant="standard">
            <Typography sx={{ textAlign:"left", color: "#273240", fontSize: "0.8rem", mb: 1, fontWeight: "700"  }}>Confirm Password</Typography>
              <TextField
              sx={{ 
                "& input::placeholder": {
                  fontSize: "0.8rem",
          ...
          <Typography sx={{ color: "#8d8d8d", fontSize: "0.8rem", fontWeight: "700", mt: 2 }}>Already User ? <Link to={"/login"} style={{ textDecoration: "none" }}>Sign In</Link></Typography>
